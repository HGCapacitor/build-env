...
while getopts ":hls:y" opt; do
    ...
    h)
        ...
        ;;
    l)
        PROGRAM_ACTION='LIST_BUILD_STEPS'
        ;;
    s)
        PROGRAM_ACTION='EXECUTE_BUILD_STEP'
        STEP_NAME=${OPTARG}
        ;;
    y)
        AUTOBUILD="y"
...
BUILD_STEPS_DIR="${BUILD_ENV_ROOT}/build-tools-steps.d"
...
then
    ...
    echo "WARNING: No build-tools-steps.d directory, please validate if this is correct"
fi
